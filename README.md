...
The bundled files cover 2021–2025 and are the sole inputs to every
script in this repository. The BigQuery extraction queries used to
build them are available from the author on request.
